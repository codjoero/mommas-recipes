...
import {
  GET_USER_RECIPES, DELETE_USER_RECIPE, GET_ALL_RECIPES,
  GET_CURRENT_USER, UPDATE_USER_RECIPE
} from '../../queries';
...
class UserRecipes extends React.Component {
  ...
  updateCache = (cache, { data: { deleteUserRecipe } }, username) => {
        ...
        return (
          <ul>
            ...
            {!data.getUserRecipes.length && (
              <p>
                <strong>You haven't added any recipe yet</strong>
              </p>
            )}
            {data.getUserRecipes.map(recipe => (
              <li key={recipe._id}>
                ...
                <Mutation
                  ...
                  update={(cache, data) => this.updateCache(cache, data, username)}
                  refetchQueries={() => [
...
const EditRecipeModal = ({
  handleSubmit, recipe, handleChange, closeModal
}) => (
  <Mutation 
